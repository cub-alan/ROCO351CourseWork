...
chance = rand(1); % create a random number from 0 and 1
...
if chance < 0.9 % if the chance is in the 90%
    ...
    action = randi(4); % create a random integer between 1 and 4 to set as the random north east south west value
end
end